...
module("LuaScript.View.Panel.Activity.RechangeAward.RechangeAwardPanel")
local mStr = nil
...
function Display()
	local activity = mActivityManager.GetActivity(ActivityType.RechangeAward)
	if activity.data[1].startTime > 1388505600 then
...
function OnGUI()
	...
	local image = mAssetManager.GetAsset("Texture/Gui/Bg/rechangeAward")
	GUI.DrawTexture(80,100,1024,512,image)

	GUI.Label(240,178,84,30,mStr, GUIStyleLabel.Left_20_White, Color.Black)
	GUI.Label(855,178,94,30,"目前累计充值:"..hero.totalRecharge, GUIStyleLabel.Right_20_White, Color.Black)
...
function DrawAward(x, y, packageId, gold, got, index)
	...
	-- GUI.Label(x,y-50,86,30,cfg_item.name, GUIStyleLabel.Center_35_Brown_Art)
