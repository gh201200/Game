...
public class CustomFontMaker : EditorWindow
{
    ...
    [MenuItem("Tools/Create Cumstom Font", false, 10)]
    static void AddWindow()
    {
        //创建窗口
        Rect wr = new Rect(0, 0, 400, 60);
        CustomFontMaker window = (CustomFontMaker)EditorWindow.GetWindowWithRect(typeof(CustomFontMaker), wr, false, "自定义字体");
        window.Show();
    ...
    void CreateFont()
    {
        ...
        Debug.Log("Create Custom Font Success!");
    }
}