...
public class Lua_LTSpline : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int generateVectors(IntPtr l) {
		try {
			LTSpline self=(LTSpline)checkSelf(l);
			var ret=self.generateVectors();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_constantSpeed(IntPtr l) {
		try {
			LTSpline self=(LTSpline)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.constantSpeed);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_constantSpeed(IntPtr l) {
		try {
			LTSpline self=(LTSpline)checkSelf(l);
			System.Boolean v;
			checkType(l,2,out v);
			self.constantSpeed=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,drawGizmo);
		addMember(l,drawLinesGLLines);
		addMember(l,generateVectors);
		addMember(l,drawGizmo_s);
		...
		addMember(l,"constantSpeed",get_constantSpeed,set_constantSpeed,true);
