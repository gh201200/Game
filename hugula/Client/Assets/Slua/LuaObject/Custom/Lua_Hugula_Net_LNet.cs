...
public class Lua_Hugula_Net_LNet : LuaObject {
	...
	static public int get_main(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Net.LNet.main);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Hugula.Net.LNet");
		addMember(l,Connect);
		...
		createTypeMetatable(l,null, typeof(Hugula.Net.LNet),typeof(UnityEngine.MonoBehaviour));
	}
}
