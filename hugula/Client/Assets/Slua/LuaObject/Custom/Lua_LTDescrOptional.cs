...
public class Lua_LTDescrOptional : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			LTDescrOptional o;
			o=new LTDescrOptional();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"LTDescrOptional");
		addMember(l,reset);
		addMember(l,callOnUpdate);
		...
		createTypeMetatable(l,constructor, typeof(LTDescrOptional));
	}
}
