...
public class Lua_Hugula_Net_Msg : LuaObject {
	...
	static public int Debug_s(IntPtr l) {
		try {
			...
			var ret=Hugula.Net.Msg.Debug(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(Hugula.Net.Msg));
	}
}
